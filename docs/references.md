...
| 必须通过的检查 | `protect-main` 追加 Require status checks to pass：`repo hygiene`；未勾选 “up to date before merging” | 所有者操作截图（Ruleset updated）；PR #5 检查运行中 `blocked`、通过后 `clean` | 2026-09-24 |
