...
| [`2026-09-24-multi-agent-workflows`](2026-09-24-multi-agent-workflows/README.md) | 从 AI 自组织大项目提炼可用的多 Agent 工作流 | 完成 | 共同骨架是“契约 + 文件所有权 + 共享状态 + 集成核对”；补充 macOS 27 案例（一目录一 owner + 注册表）；提出 10 条候选规则与迷你泰坦尼克号试点，待采纳 |
